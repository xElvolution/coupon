  ...
  useGSAP(
    () => {
      ...
      const render = () => {
        ...
        if (e) e.textContent = v.est ? fmt(v.est * p.est) : "…";
      ...
      const tl = gsap.timeline({
        ...
        scrollTrigger: {
          ...
          pin: true,
          scrub: 0.6,
          snap: { snapTo: [0, 0.42, 1], duration: { min: 0.2, max: 0.6 }, ease: "power2.inOut" },
      ...
      tl.to({}, { duration: 0.1 })
        ...
        .to(q(".hs-share"), { x: -24, rotate: -1.5, duration: 0.25, ease: "power2.out" }, ">")
        .to(q(".hs-coupon"), { x: 24, rotate: 1.5, duration: 0.25, ease: "power2.out" }, "<")
      ...
      <div className="hs-pin relative flex min-h-screen items-center overflow-hidden py-20">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="card relative overflow-hidden p-5 sm:p-7">
            ...
            <div className="relative mt-7 flex gap-0">
              <div className="hs-share relative w-[55%] rounded-l-2xl border border-line-2 bg-surface-2 p-4">
              ...
              <div className="relative w-0">
                <div className="perf-v absolute -left-1 bottom-0 top-0 w-2" />
                <div className="hs-cutline absolute bottom-0 left-[-1px] top-0 w-[2px] origin-top scale-y-0 bg-lime shadow-[0_0_14px_#c8f560]" />
              </div>
              <div className="hs-coupon relative w-[45%] overflow-hidden rounded-r-2xl border border-lime/30 bg-[#12170e] p-3">
            ...
            <div className="mt-6 flex items-end justify-between">
              <div className="text-xs text-dim">Priced from Pyth SPYx × trailing onchain yield, {Math.round(SELL_DISCOUNT * 100)}% seller discount.</div>
