...
try { const s = await c.requestAirdrop(kp.publicKey, 0.5 * LAMPORTS_PER_SOL); await c.confirmTransaction(s); console.log("airdrop ok", s); } catch (e) { console.log("airdrop fail", e.message); }
